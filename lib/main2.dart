...
class _CalculatorState extends State<Calculator> {
  ...
  void ans(String b) {
    double result=0;
    if(m=='+') result=double.parse(a1) + double.parse(a2);
    else if(m=='-') result=double.parse(a1) - double.parse(a2);
    else if(m=='*') result=double.parse(a1) * double.parse(a2);
    else result=double.parse(a1) / double.parse(a2);
    if(result.toInt().toDouble()== result) a1=result.toInt().toString();
    else a1=result.toString();
    setState(() {
      value=a1;
    });
  }
